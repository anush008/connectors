...
class EndpointConfig(BaseModel):
    ...
    start_date: AwareDatetime = Field(
        ...
        title="Start Date",
        description="UTC date and time in the format YYYY-MM-DDTHH:MM:SSZ. Report data before this date will not be replicated. If left blank, the start date will be set to 30 days before the present.",
    )
